...
<!-- always leave a gap on top and on bottom for images -->
...
"_PowerShell is great because we had a series of rockstar engineers add their awesomeness to the project_."

( from the [_interview_](https://evrone.com/blog/jeffrey-snover-interview) with Jeffrey Snover, PowerShell Inventor)
